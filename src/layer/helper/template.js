...
const templateA = (
    ...
    if (Array.isArray(contentInfo)) {
      contentInfo.forEach((el) => {
        content = content +
          `<div style="line-height: 1.7; font-size: 15px; margin-top: 1.2em; font-family: Yu Gothic, Hiragino Kaku Gothic ProN, sans-serif; word-break: break-all;">${el.title}</div>
    ...
    <tr>
    <td style="text-align: left; width: 400px;"><a href="https://dev.myforex.com/access.php?id=home&ln=ja" target="_blank"><img src="${urlImage}/logo_color.png" alt="Myforex" width="147" height="17" border="0"></a></td>
  ...
  ${title}
    ...
    <tr>
    <td valign="top">
    <div style="line-height: 1.7; font-size: 15px; font-family: Yu Gothic, Hiragino Kaku Gothic ProN, sans-serif;"><a href="https://dev.myforex.com/access.php?id=contact&ln=ja" target="_blank" style="color: #1F2672; text-decoration: none;">${lang.cm_inquiries_email}</a></div>
    </td>
    <td valign="top">
    ...
    <div style="line-height: 1.7; font-size: 13px; text-align: center; margin-top: 1.2em; font-family: Yu Gothic, Hiragino Kaku Gothic ProN, sans-serif;"><a href="https://dev.myforex.com/access.php?id=tandc&ln=ja" target="_blank" style="color: #1F2672; text-decoration: none;">${lang.cm_tandc}</a> | <a href="https://dev.myforex.com/access.php?id=kyc&ln=ja" target="_blank" style="color: #1F2672; text-decoration: none;">${lang.cm_kyc}</a> | <a href="https://dev.myforex.com/access.php?id=privacy-policy&ln=ja" target="_blank" style="color: #1F2672; text-decoration: none;">${lang.cm_privacy_policy}</a></div>
    </td>
    </tr>
    </table>
    </td>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
    <tr>
    <td style="width: 167px;"><a href="https://dev.myforex.com/access.php?id=home&ln=ja" target="_blank"><img src="${urlImage}/footer_logo.png" alt="Myforex" width="165" height="23" border="0"></a></td>
    <td style="padding: 0 2em">
    <div style="line-height: 1.7; font-size: 13px; font-weight: bold; font-family: Yu Gothic, Hiragino Kaku Gothic ProN, sans-serif;">MYFOREX INVESTMENT LTD</div>
    <div style="line-height: 1.7; font-size: 13px; margin-top: 0.5em; font-family: Yu Gothic, Hiragino Kaku Gothic ProN, sans-serif;">GLOBAL GATEWAY 8, RUE DE LA PERLE, <br>PROVIDENCE, MAHE, SEYCHELLES</div>
    </td>
    <td style="width: 130px; text-align: right;">
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
    <tr>
    <td style="text-align: left;">
    <a href="https://dev.myforex.com/access.php?id=facebook" target="_blank"><img src="${urlImage}/footer_facebook.png" alt="facebook" width="32" height="32" border="0"></a></td>
    <td style="text-align: center; padding: 0 10px;">
    <a href="https://dev.myforex.com/access.php?id=twitter" target="_blank"><img src="${urlImage}/footer_twitter.png" alt="twitter" width="32" height="32" border="0"></a>
    </td>
    <td style="text-align: right;">
    <a href="https://dev.myforex.com/access.php?id=youtube" target="_blank"><img src="${urlImage}/footer_youtube.png" alt="Youtube" width="32" height="32" border="0"></a>
    </td>
    </tr>
    </table>
    </td>
    ...
    <tr>
    <td>
    <div style="line-height: 1.7; font-size: 13px; text-align: center; color: #FFFFFF; font-family: Yu Gothic, Hiragino Kaku Gothic ProN, sans-serif;">Copyright &copy; 2020-2022 MYFOREX INVESTMENT LTD. All rights reserved.</div>
    </td>
    </tr>
    </table>
    </td>
